...
namespace praxis
{
    ...
    {
        public static UInt128 ComputeHash(ReadOnlySpan<byte> key, UInt128 seed = default)
        {
            var len = key.Length;
            var nblocks = len / 16;
        ...
        public static UInt128 ComputeHash(string key, UInt128 seed = default)
        {
        ...
        public static UInt128 ComputeHash(StringBuilder key, UInt128 seed = default)
        {
            var len = key.Length * 2; // chars are 16 bits
            var nblocks = key.Length / 8;
        ...
        public static UInt128 ComputeHash(ulong key, UInt128 seed = default)
        {
            const int len = 4;
